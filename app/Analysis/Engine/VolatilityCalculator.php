...
final class VolatilityCalculator
{
     ...
     *
     * @param  array  $records  Array of OHLC records with 'close' key
     * @param  int  $lookbackPeriod  Number of periods for rolling calculation (minimum 30 recommended)
     * @return array Array of volatility values (as decimals, not percentages)
     */
     ...
     *
     * @param  array  $records  Array of OHLC records
     * @return array Array of log return values
     */
     ...
     *
     * @param  array  $logReturns  Array of log return values
     * @param  int  $lookbackPeriod  Number of periods for calculation
     * @return array Array of volatility values
     */
     ...
     *
     * @param  array  $blockRecords  Array of OHLC records
     ...
     *
     * @param  array  $volatilities  Array of volatility values
