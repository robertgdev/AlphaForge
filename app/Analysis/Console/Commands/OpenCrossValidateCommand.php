...
use App\Analysis\Engine\Validation\ValidationOrchestrator;
use App\Analysis\Exception\AnalysisException;
use App\Analysis\Renderer\ValidationRenderer;
...
final class OpenCrossValidateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'stoch:analysis:opencross-validate
