...
class ObjectivePresets
{
    public static function sharpeFocused(): CompositeObjective
    {
        return new CompositeObjective(
            [
                ...
                new ObjectiveWeight('max_drawdown_percent', -0.3),
            ],
            'sharpe_focused',
        );
    }
    ...
    public static function balanced(): CompositeObjective
    {
        return new CompositeObjective(
            [
                ...
                new ObjectiveWeight('sharpe_ratio', 10.0),
                new ObjectiveWeight('win_rate', 0.5),
            ],
            'balanced',
        );
    }
    ...
    public static function conservative(): CompositeObjective
    {
        return new CompositeObjective(
            [
                new ObjectiveWeight('max_drawdown_percent', -2.0),
                new ObjectiveWeight('profit_factor', 1.0),
                new ObjectiveWeight('sortino_ratio', 5.0),
            ],
            'conservative',
        );
    }
    ...
    public static function aggressive(): CompositeObjective
    {
        return new CompositeObjective(
            [
                ...
                new ObjectiveWeight('sharpe_ratio', 5.0),
